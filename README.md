...
Scalakml is an exercise I did to learn the basics of scala, the result of which may be useful to others.
...
The scalakml library consists of 4 packages:
...
Note a FeaturePart is part of the Feature trait. A FeaturePart can be created and is typically added to a
...
## Issues
  ...
  such that angle brackets and ampersands in CDATA are corrupted, Google Earth for example does not like that.
...
An example kml file from http://code.google.com/p/kml-samples/ is included in the kml-files directory.
